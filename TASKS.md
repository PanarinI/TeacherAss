...
[ ] сравнить gpt-4.1 и o4-mini
[ ] вынести в промпте в отдельный блок рекомендации по занятияю и classroom management (по запросу - дополнительная опция)
...
[ ]
## in progress
[ ] интерфейс, аналогичный logoKonspekt
[ ] автозаполнение поля Учебник (по словарю)
[ ] закомментить параметры, которые не будут в релизе - прописать к ним логику развития
[ ] 2-3 страницы в input
[ ] web search
...
[x] проверка различных основных учебников
[x] промпт для методики PPP - динамический
[x] параметры корректно передаются в промпт динамически
