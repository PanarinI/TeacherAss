def build_prompt(params):
    ...
    if params.get('extra_info'):
        base_prompt.append(f"- Дополнительная информация от учителя, которая может может влиять на твои решения в планировании: {params['extra_info']}."),
    if params.get('hw_required'):
        base_prompt.append(f"- Разработай домашнее задание, логично вытекающее из урока")
